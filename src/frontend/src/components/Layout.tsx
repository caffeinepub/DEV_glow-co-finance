    ...
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      >
        ...
        <div className="flex items-center gap-3 px-4 py-5 border-b border-sidebar-border min-h-[65px]">
          ...
          {!collapsed && (
            <div className="min-w-0">
              ...
              <p className="text-sidebar-foreground/60 text-[11px] truncate">
                Finance Dashboard
              </p>
            </div>
          )}
        ...
        <button
          ...
          className="hidden lg:flex items-center justify-center p-3 border-t border-sidebar-border text-sidebar-foreground/60 hover:text-sidebar-foreground transition-smooth"
